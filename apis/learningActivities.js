...
exports.learningActivities = function (req, res) {
	var fields = ['LnDUserId'],
		aggFields = ['totalActiveUsers:SUM', 'activeUsersSinceLastMonth:SUM', 'enrolledUsers:SUM','enrolledUsersSinceLastMonth: SUM',
					...
					'usersHaveNotStarted:SUM','usersOnTrack:SUM','usersAheadSchedule:SUM','learnerSatisfaction:SUM','learnerSatisfactionBy:AVG', 'trainerRating:SUM',
					'trainerRatingBy:AVG','contentRating:SUM','contentRatingBy:AVG'],
